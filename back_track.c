...
void flood_fill(png_bytep *row_pointers, int x, int y, int width, int height, unsigned char r, unsigned char g, unsigned char b, int **visited) {
    ...
    while (top >= 0) {
        ...
        if (*px == 255 && *(px+1) == 255 && *(px+2) == 255) { // 黒いピクセル
            *px = r;
            *(px+1) = g;
            *(px+2) = b;
            visited[p.y][p.x] = 1;
...
//         flood_fill(row_pointers, x + 1, y, width, height, r, g, b, visited);
//         flood_fill(row_pointers, x - 1, y, width, height, r, g, b, visited);
//         flood_fill(row_pointers, x, y + 1, width, height, r, g, b, visited);
//         flood_fill(row_pointers, x, y - 1, width, height, r, g, b, visited);
//     }
// }
...
// int main() {
//     const char *input_file = "test2.png";
//     const char *output_file = "test3.png";
